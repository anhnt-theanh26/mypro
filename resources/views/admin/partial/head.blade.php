...
<!-- Icons -->
<link rel="stylesheet" href="{{ asset('/administrator/assets/vendor/fonts/fontawesome.css') }}" />
<link rel="stylesheet" href="{{ asset('/administrator/assets/vendor/fonts/tabler-icons.css') }}" />
<link rel="stylesheet" href="{{ asset('/administrator/assets/vendor/fonts/flag-icons.css') }}" />

<!-- Core CSS -->
<link rel="stylesheet" href="{{ asset('/administrator/assets/vendor/css/rtl/core.css') }}"
    class="template-customizer-core-css" />
<link rel="stylesheet" href="{{ asset('/administrator/assets/vendor/css/rtl/theme-default.css') }}"
...
<link rel="stylesheet" href="{{ asset('/administrator/assets/vendor/libs/datatables-bs5/datatables.bootstrap5.css') }}" />
<link rel="stylesheet"
    href="{{ asset('/administrator/assets/vendor/libs/datatables-responsive-bs5/responsive.bootstrap5.css') }}" />
<link rel="stylesheet" href="{{ asset('/administrator/assets/vendor/libs/datatables-buttons-bs5/buttons.bootstrap5.css') }}" />
